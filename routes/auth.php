...
Route::middleware('guest')->group(function () {
    ...
    Route::get('login/google-redirect', [AuthenticatedSessionController::class, 'googleProvider'])
                ->name('google');

    Route::get('login/google-callback', [AuthenticatedSessionController::class, 'googleCallback']);
    
    Route::get('login/github-redirect', [AuthenticatedSessionController::class, 'githubProvider'])
                ->name('github');
